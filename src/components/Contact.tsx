      ...
      <div className="relative bg-grey rounded-45xl py-[62.5px] px-6 sm:px-[50px] md:px-[100px] flex overflow-hidden">
        <form className="w-full lg:w-[60%] xl:w-1/2 max-w-[559px] space-y-10">
          <div className="flex justify-evenly md:justify-stretch items-center gap-8">
            ...
            <div className="flex flex-row-reverse gap-3.5 items-center">
              <label htmlFor="quoteCheck" className="text-lg">
                Get a quote
              </label>
              <input
                type="radio"
            ...
            <div className="relative mb-4">
              ...
              <div className="relative">
                <input
                  ...
                  name="name"
                  placeholder="Name"
                  className="w-full rounded-xl.5 border py-1 px-3 text-base leading-8 transition-colors duration-200 ease-in-out placeholder:text-gray-500 focus:border-blue-500 focus:bg-white focus:ring-2 focus:ring-transparent"
                />
              </div>
            </div>
